...
namespace BlazorApp.Server.Data
{
    public class CoreDbContext : DbContext
    {
        ...
        {
            this.options = options ?? GetOptions(AppConst.APP_SQL);
        }
        ...
        //ApiAuthorizationDbContext<AspNetUser> do not modify
        public virtual DbSet<AspNetUser> Users { get ; set ; } = default!;
        public virtual DbSet<AspNetUserClaim> UserClaims { get; set; } = default!;
        public virtual DbSet<AspNetUserLogin> UserLogins { get; set; } = default!;
        public virtual DbSet<AspNetUserToken> UserTokens { get; set; } = default!;
        public virtual DbSet<AspNetUserRole> UserRoles { get; set; } = default!;
        public virtual DbSet<AspNetRole> Roles { get; set; } = default!;
        public virtual DbSet<AspNetRoleClaim> RoleClaims { get; set; } = default!;
        public virtual DbSet<AspNetDeviceCode> DeviceCodes { get; set; } = default!;
        public virtual DbSet<AspNetKey> Keys { get; set; } = default!;
        public virtual DbSet<AspNetPersistedGrant> PersistedGrants { get; set; } = default!;

        //ApiAuthorizationDbContext<ApplicationUser> do not modify

        public virtual DbSet<NameSuffix> NameSuffix { get; set; } = default!;
